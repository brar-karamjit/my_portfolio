          ...
          <Row className="align-items-center home-hero-row">
            <Col md={7} className="home-header home-hero-text">
              ...
              <p className="home-subtitle">
                I build and scale platform infrastructure across cloud and on-premise environments, empowering engineering teams with reliable automation and self-service capabilities.
              </p>
