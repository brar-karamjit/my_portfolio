      ...
      <Container className="home-surface home-social-section">
        ...
        >
          <div className="home-social-content">
            ...
            <p className="section-subtitle">
              Always open to discussing new projects, ideas, or opportunities to be part of your visions. Whether you have a question or just want to say hi, I'll try my best to get back to you!
            </p>
